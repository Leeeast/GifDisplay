...
Java_com_ldl_gifdisplay_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_ldl_gifdisplay_GifHandler_loadPath(JNIEnv *env, jobject instance, jstring path_) {
...
Java_com_ldl_gifdisplay_GifHandler_getWidth(JNIEnv *env, jobject instance, jlong ndkGif) {
    GifFileType *gifFileType = (GifFileType *) ndkGif;
    return gifFileType->SWidth;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ldl_gifdisplay_GifHandler_getHeight(JNIEnv *env, jobject instance, jlong ndkGif) {
    GifFileType *gifFileType = (GifFileType *) ndkGif;
    return gifFileType->SHeight;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ldl_gifdisplay_GifHandler_updateFrame(JNIEnv *env, jobject instance, jlong ndkGif,
                                               jobject bitmap) {
